...
## High level overview
I choose [Protonmail](https://protonmail.com/) as my email provider, a single rule filter, 3 custom folders, and the built-in contacts and mark as spam features.

I am using a custom domain that I already own; my legacy email is cmolina@hey.com; the new one is hi@cmolina.dev. One less character ❤️

The new Inbox looks like this:
![A screenshot of the Protonmail web client](/img/2021/05/protonmail-screenshot.png)

Did you notice the Paper trail, Screening and The Feed?
